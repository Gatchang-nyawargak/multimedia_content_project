...
const BlogPost = () => {
  return (
    ...
    <h2 className='heading'>Trevor Noah: "Born a Crime"</h2>
      <div className='intro'>
      <p>
      ...
      <div className='trevor-book'>
        <div>
        <img src = "/images/trevor-book.jpg" width={300} height={400} className='trevor-pic'></img>
      </div>
      ...
      <div className='profile'>
        ...
        <img src = "images/trevor-pic.png" width={300} height={400}></img>
        </div>
    ...
    <div>
   <button className='read-more'> <a href = "https://pursuitofdiversity.wordpress.com/wp-content/uploads/2018/06/born-a-crime-trevor-noah.pdf"></a>Read More </button>
    </div>
