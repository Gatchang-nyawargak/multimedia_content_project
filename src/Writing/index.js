  ...
  return (
    <div className="blog-post">
      ...
      <div className='trevor-book'>
        <div>
          <img src="/images/trevor-book.jpg" width={300} height={400} className='trevor-pic' alt="Trevor Book Cover"></img>
        </div>
      ...
      <div className='profile'>
        ...
        <div className='trevor-image'>
          <img src="images/trevor-pic.png" width={300} height={400} alt="Trevor Profile Picture"></img>
        </div>
      </div>
      <br /><br />
