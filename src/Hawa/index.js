...
function HawaPortfolio(){
    return(
        <div className="details">
            ...
            <div  className="personal-statements"><p><h2>Hawa Majid</h2></p>
            <h2><b>Personal Statement</b></h2>
            <div className="personal-statement"><p>The ongoing crisis impacting ocean ecosystems, characterized by widespread pollution and habitat destruction, has become a pressing global issue. Recognizing the urgency of these challenges, Hawa is eager to leverage her technological expertise to spearhead innovative solutions to address these critical problems. She aims to revolutionize waste management and conservation practices by developing advanced technologies to combat marine pollution effectively. Her vision is to contribute to a sustainable future by utilizing technology to drive positive change in environmental stewardship, ensuring a cohesive and impactful approach to safeguarding our oceans. </p></div>
            </div>
            ...
            <li>Knowledge of unit testing, writing and running end-to-end tests, and using testing tools in Python.</li>
             ...
             <div className="contact"><p><b>email:</b>majidhawaah@gmail.com
             <br></br>
